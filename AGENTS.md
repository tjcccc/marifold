...
v0.0.1 only implements the TypeScript CLI foundation for priests-style ask/chat/profile/session behavior.
...
- Do not implement SkillApp, Workflow, Web UI, Apple apps, external-agent aliases, or agentic tool loops in v0.0.1.
